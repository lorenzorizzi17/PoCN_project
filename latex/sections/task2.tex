...
\begin{figure}
	...
	\caption{\textit{On the left, resulting graphs of Belgium's or France's railroad network with stations as nodes ($minStation = 20 km, minRails = 20 km$ for Belgium, $minStation = 40 km, minRails = 40 km$ for France). On the left, the corresponding spatial rendering from EGM GIS data}}
	\label{fig:Belgium}
\end{figure}
